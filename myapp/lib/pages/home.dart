...
// Model definitions - renamed System to HomeSystem to avoid conflicts
class HomeSystem {
  final String id;
  final String name;
  ...
  factory HomeSystem.mock(String id, String name) => HomeSystem(
        id: id,
        name: name,
...
class HomePage extends StatelessWidget {
  ...
  final Function(HomeSystem) onSystemClick;
              ...
              child: RefreshIndicator(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    Builder(
                      builder: (context) {
                        // Calculate average efficiency from systems
                        ...
                        if (systems.isNotEmpty) {
                          ...
                          for (var sys in systems) {
                            try {
                              final eff = double.tryParse(sys.efficiency) ?? 0.0;
                              totalEfficiency += eff;
                              count++;
                            } catch (e) {
                              // Skip invalid values
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 6),
                                    const Text('Gérez votre énergie',
                                        style: TextStyle(
                                            color: Colors.white70, fontSize: 12)),
                                    const Text('pour produire',
                                        style: TextStyle(
                                            color: Colors.white70, fontSize: 12)),
                                    const Text('efficacement',
                                        style: TextStyle(
                                            color: Colors.white70, fontSize: 12)),
                                  ],
                                ),
